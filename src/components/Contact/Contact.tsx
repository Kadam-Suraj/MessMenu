            ...
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-lg">support@messmenu.com</span>
                            </div>
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-lg">123 Menu Street, Food City</span>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <Button className="w-full" type="submit" onClick={(e) => e.preventDefault()}>Send Message</Button>
                    </motion.form>
                </div>
            </div>
        </div>
